...
<div class="ck-feedback-page-wrap">
  ...
  <div class="ck-dl-hero">
    <div class="ck-dl-badge">🌱 Listening to Every Creator</div>
    <h1 class="ck-dl-title">Feedback & Roadmap</h1>
    <p class="ck-dl-desc">
      Whether reporting a bug, requesting new painting app integrations, or sharing creative ideas, share them directly with us.
    </p>
