...
<div class="ck-download-wrap">
  ...
  <div class="ck-dl-hero">
    ...
    <div class="ck-dl-tags">
      ...
      <span class="ck-dl-tag">🛡️ 免管理员权限</span>
      <span class="ck-dl-tag">⚡ 极速双击即启</span>
      <span class="ck-dl-tag">📦 便携无残留</span>
    </div>
  </div>
  ...
  <div class="ck-dl-box">
    ...
    <div class="ck-dl-primary-action">
      ...
      >
        ...
        <span>
          立即下载 Colorink 独立版
          <span class="ck-dl-btn-meta">单文件免安装 · 双击即可运行 (.exe)</span>
        </span>
      </a>
    </div>
    ...
    <div class="ck-mirror-bar">
      <span class="ck-mirror-tag">⚡ 国内加速</span>
      <span>如遇 GitHub 直连下载缓慢，请点击高速镜像：</span>
      <a
  ...
  <div class="ck-dl-notice">
    ...
    Colorink 为个人全免费开源软件，尚未花费高昂年费采购微软商业企业证书。若初次运行提示「Windows 已保护你的电脑」或「未知发行者」：<br />
    请点击界面上的 <strong>「更多信息」</strong> → <strong>「仍要运行」</strong> 即可正常开启。代码完全在 GitHub 开源，绝不包含任何恶意行为。
  </div>
