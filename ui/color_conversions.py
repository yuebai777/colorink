...
# D50→D65 是 D65→D50 的精确逆（Lindbloom Bradford 系数）。旧版用的近似
# 值不是 A 的逆，RGB→Lab→RGB 往返会漂移约 0.9/255（见 test 的容差）。
_LAB_D50_TO_D65 = (
    (0.9555766558, -0.0230393428,  0.0631636684),
    (-0.0282895469,  1.0099416212,  0.0210076609),
    (0.0122981793, -0.0204830040,  1.3299098908),
)
